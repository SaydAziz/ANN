...
namespace simple_neural_network
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Player 1 Inventory: ");
            currentGame.p1.PrintInv();
            Console.WriteLine("\nPlayer 2 Inventory: ");
            currentGame.p2.PrintInv();


            Console.WriteLine("\n\nPlayer 1 Power Level: ");
            var output1 = curNeuralNetwork.Think(currentGame.p1.getInv());
            Console.WriteLine("Level " + (output1[0,0] * 100).ToString().Substring(0,2));

            Console.WriteLine("\nPlayer 2 Power Level: ");
            var output2 = curNeuralNetwork.Think(currentGame.p2.getInv());
            Console.WriteLine("Level " + (output2[0, 0] * 100).ToString().Substring(0, 2));
